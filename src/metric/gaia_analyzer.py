...
def analyze_gaia_results(jsonl_file):
    """Analyze GAIA results and show comparison between predictions and true answers"""
...
if __name__ == "__main__":
    analyze_gaia_results("workdir/gaia/dra.jsonl") 